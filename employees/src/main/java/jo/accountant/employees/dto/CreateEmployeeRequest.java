 ...
 * @param overtimeHours25     Heures supplémentaires majorées à +25% (Finding #18, défaut 0)
 * @param overtimeHours50     Heures supplémentaires majorées à +50% (Finding #18, défaut 0)
 * @param overtimeHours100    Heures supplémentaires majorées à +100% (R-20 lot-B, Haïti >56h/dimanche/férié, défaut 0)
 * @param absenceDays         Jours d'absence non rémunérés sur la période (Finding #18, défaut 0)
 * @param paidLeaveDays       Jours de congés payés pris sur la période (Finding #18, défaut 0)
 * @param cnssNumber          Matricule CNSS Haïti (10 chiffres, R-20 lot-B, nullable)
 * @param ofatmaSectorCode    Code secteur OFATMA pour taux accidents variable 0.5-6% (R-20 lot-B, nullable)
