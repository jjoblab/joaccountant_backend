...
/**
 * Endpoints des employés (restructuration 2026-07-24 — module :employees).
 *
...
@Tag(name = "Employees", description = "Employés / RH (restructuration 2026-07-24)")
public class EmployeesController {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "201",
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                ...
                examples = @ExampleObject(name = "Employé CDI créé avec V49 (HS + absences)", value = """
                    {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200",
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                schema = @Schema(implementation = EmployeeResponse.class),
                examples = @ExampleObject(name = "2 employés actifs avec V49", value = """
                    [
                      {
                        "id": "0192a8d7-1c2d-3e4f-5a6b-7c8d9e0fabcd",
                        "companyId": "0192a8d5-1c2d-3e4f-5a6b-7c8d9e0fabcd",
    ...
    @Operation(summary = "Détail d'un employé",
        description = "Retourne la fiche complète d'un employé, y compris les champs V49 (heures sup, absences, congés).")
    @ApiResponses({
        @ApiResponse(responseCode = "200",
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                schema = @Schema(implementation = EmployeeResponse.class),
