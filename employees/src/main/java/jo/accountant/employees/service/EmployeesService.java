...
/**
 * Service des employés (restructuration 2026-07-24 — module :employees).
 *
...
public class EmployeesService {
    ...
    public EmployeeResponse create(UUID companyId, CreateEmployeeRequest req) {
        ...
        // Finding #18 — HS / absences / congés (défaut 0 si null)
        emp.setOvertimeHours25(req.overtimeHours25());
        emp.setOvertimeHours50(req.overtimeHours50());
        // R-20 (lot-B) — HS +100% Haïti (>56h, dimanches, jours fériés) + matricule CNSS/OFATMA
    ...
    public List<EmployeeResponse> list(UUID companyId, EmployeeStatus statusFilter) {
        // Audit v4.7 §7.2 Finding #5 — hard cap 500 pour empêcher l'OOM. La liste d'employés est
