-- V58 — Lot B R-20 — Rendre MONTHLY_LEGAL_HOURS configurable + overtimeHours100 + cnssNumber +
...
--   - Employee ne supportait que HS +25% et +50% (Finding #18). Or le Code du travail
