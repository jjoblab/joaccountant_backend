...
public class ReportingService {
    ...
    private ExportResult exportBalanceSheetPdf(UUID companyId, LocalDate asOf) {
        ...
        documentGenerationService.generateDocument(
            companyId,
            jo.accountant.documentgeneration.entity.DocumentType.BALANCE_SHEET,
            resourceId,
            variables);
    ...
    private ExportResult exportIncomeStatementPdf(UUID companyId, LocalDate from, LocalDate to) {
        ...
        documentGenerationService.generateDocument(
            companyId,
            jo.accountant.documentgeneration.entity.DocumentType.INCOME_STATEMENT,
            resourceId,
            variables);
    ...
    private ExportResult exportDonorReportPdf(UUID companyId, UUID grantId) {
        ...
        documentGenerationService.generateDocument(
            companyId,
            jo.accountant.documentgeneration.entity.DocumentType.DONOR_REPORT,
            resourceId,
            variables);
