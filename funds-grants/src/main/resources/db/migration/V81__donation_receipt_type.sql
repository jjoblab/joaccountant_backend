...
--
-- CONTEXTE : avant V8-5, tous les dons (cash + en nature) étaient comptabilisés via
...
-- pour préserver la rétro-compatibilité (les reçus créés avant V8-5 sont considérés cash).
