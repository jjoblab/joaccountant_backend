-- V56 — Lot B R-08 — Mentions légales Haïti (Code Fiscal art. 196) + colonne country_code sur
...
--      NULL = template international / France (comportement historique avant V56).
