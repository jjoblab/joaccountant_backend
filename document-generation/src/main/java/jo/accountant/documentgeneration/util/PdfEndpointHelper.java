...
/**
 * Helper utilitaire pour les endpoints PDF des controllers Reports Hub (v2.5.0-task8).
 *
 * <p>Extrait le boilerplate commun aux 12+ endpoints PDF qui suivent le même pattern
 * introduit en v2.4.1/v2.4.2 (step2-backend / step7-backend) :
 * <ol>
 ...
 *
 * <p><strong>Signature deviation from task spec</strong> — la task spec v2.5.0-task8
