...
/**
 * Type d'état financier (§13 Phase 6 + audit v4.7 §3.1 + v7-2 IAS 1.106).
 *
 * <ul>
 ...
 * Audit v4.7 §3.1 obligatoire en IFRS (IAS 7) et SYSCOHADA. La méthode
...
public enum FinancialStatementType {
 BALANCE_SHEET,
 INCOME_STATEMENT,
 CASH_FLOW_STATEMENT, // Audit v4.7 §3.1 ajout
