...
import jo.accountant.invoicing.signature.SignableDocumentType;
...
public class InvoicingController {
 ...
 // — Service de signature électronique (NoOp par défaut, XAdES si configuré)
 ...
 "à 200). remplace la variante List<> hard-cappée à 200 pour " +
 ...
 */
 ...
 /**
 * — Signe électroniquement le PDF d'une facture.
 *
 ...
 * <li>Appelle {@link ElectronicSignatureService#sign} avec le type {@link SignableDocumentType#INVOICE}.</li>
 ...
 */
 ...
 description = "Signe le PDF de la facture avec un certificat qualifié (XAdES/PAdES). "
 ...
 try {
 SignatureResult result = signatureService.sign(pdf, SignableDocumentType.INVOICE, companyId);
