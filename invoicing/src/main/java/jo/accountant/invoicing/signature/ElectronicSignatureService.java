...
/**
 * Service de signature électronique de documents (R-36 — lot-F3-security).
 *
...
public interface ElectronicSignatureService {
     ...
     * @param documentType  le type de document (INVOICE, CREDIT_NOTE, PAYSHP, FINANCIAL_STATEMENT)
     ...
     */
    SignatureResult sign(byte[] documentBytes, DocumentType documentType, UUID companyId);
