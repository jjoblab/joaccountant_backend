 ...
 * {@link ElectronicSignatureService} — R-36 (lot-F3-security).
 *
...
public class XAdESSignatureService implements ElectronicSignatureService {
    ...
    @Override
    public SignatureResult sign(byte[] documentBytes, DocumentType documentType, UUID companyId) {
        // TODO v4.9 — implémenter la signature XAdES réelle avec xades4j :
        ...
        throw new UnsupportedOperationException(
            ...
            + "(see class javadoc for steps). DocumentType=" + documentType
            + ", companyId=" + companyId + ", keystore=" + properties.getKeystorePath());
    }

    @Override
    public boolean verify(byte[] signedDocumentBytes) {
        // TODO v4.9 — implémenter la vérification XAdES réelle avec xades4j :
