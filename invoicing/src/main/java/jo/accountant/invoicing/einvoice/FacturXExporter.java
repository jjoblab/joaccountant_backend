 ...
 * (audit v4.7 §4.1 Finding #5 — FIX CRITIQUE pour conformité 2026).
 *
...
public class FacturXExporter {
     ...
     *
     * <p><b>Audit v4.7 §4.1 Finding #9 — PDF/A-3 Factur-X embarqué.</b>
     *
    ...
    private void writeExchangedDocument(XMLStreamWriter w, FacturXInvoice inv) throws XMLStreamException {
        ...
        // R-16 (lot-D-qualite-arch) — fix : writeAttribute doit être appelé AVANT writeCharacters
    ...
    private void writeSupplyChainTradeTransaction(XMLStreamWriter w, FacturXInvoice inv) throws XMLStreamException {
        ...
        // R-16 — fix : même correction que pour IssueDateTime (writeAttribute avant writeCharacters).
        w.writeStartElement(NS_UDT, "DateTimeString");
        writeAttribute(w, "format", "102");
        ...
        // R-16 — fix : writeAttribute doit précéder writeCharacters pour les éléments à attribut
    ...
    private void writeTradeParty(XMLStreamWriter w, String elementName, TradeParty party) throws XMLStreamException {
        ...
        // Lot B R-21 — NIF haïtien sérialisé comme SpecifiedTaxRegistration avec schemeID="NIF_HT".
    ...
    /**
     * Résout le schemeID du NIF pour le SpecifiedTaxRegistration Factur-X (Lot B R-21).
     *
    ...
    public record TradeParty(
        ...
        String address,
        String country,
        /** Lot B R-21 — NIF (Numéro d'Identification Fiscale) pour Haïti et pays non UE. */
        String nif
    ) {
        /**
         * Constructeur de compatibilité 6-args (avant R-21) — délègue avec {@code nif=null}.
