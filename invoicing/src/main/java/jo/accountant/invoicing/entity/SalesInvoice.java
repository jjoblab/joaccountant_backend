 ...
 * avoir uniquement.
 *
 * <p><b>R-34 (lot-F1-code-arch) — Rich aggregate methods</b> : les méthodes {@link #issue()},
...
public class SalesInvoice extends TenantAwareEntity {
    ...
    /**
     * ID de l'écriture comptable de bascule TVA générée au règlement (Finding #6 — TVA sur
     ...
     * encaissées ») — Finding #6. En mode {@code DEBIT}, toujours 0. En mode
    ...
    /**
     * Indique si la facture est en autoliquidation (reverse-charge intra-UE B2B) — Finding #7.
     *
     ...
     *
     * <p>Exemples de taux (seeds V64 — WithholdingRule globales Haïti) :
     * <ul>
     ...
     * factures existantes (avant V68) ont NULL dans tous les champs RS.
     *
    ...
    /**
     * R-34 (lot-F1-code-arch) — Collection transiente (non persistée) des lignes de la facture.
     *
     ...
     * pas affectés — cette collection n'est lue que par {@link #issue()} (ajoutée en R-34).
     */
    @Transient
    ...
    /**
     * R-34 — Collection transiente des lignes (cf. {@link #lines}). Jamais null.
     */
    ...
    // ════════════════════════════════════════════════════════════════════════
    //  R-34 (lot-F1-code-arch) — Méthodes métier (rich aggregate)
    // ════════════════════════════════════════════════════════════════════════
