-- V15_002 — sales invoice reverse charge
-- V45 — — Autoliquidation / reverse-charge (intra-UE B2B).
-- , le module :invoicing collectait systématiquement la TVA sur le compte 443 (TVA
