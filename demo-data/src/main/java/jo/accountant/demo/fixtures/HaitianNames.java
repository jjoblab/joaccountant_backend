...
public final class HaitianNames {
    ...
    public static final String[] FIRST_NAMES = {
        "Marie", "Jean", "Pierre", "Charles", "Joseph", "Moïse", "Saintilus",
        "Pierre-Louis", "Auguste", "Belizaire", "Cantilus", "Dorcely",
        "Roseline", "Nadège", "Frantz", "Carlo", "Emmanuel", "Jean-Robert",
        "Marie-Carmel", "Marie-Grace", "Wilner", "Evens", "Samuel", "David",
        "Daniel", "Patrick", "Ricardo", "Junior", "Christina", "Sandra"
    };
