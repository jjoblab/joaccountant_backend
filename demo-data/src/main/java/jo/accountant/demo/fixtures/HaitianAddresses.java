...
public final class HaitianAddresses {
    ...
    public static final String[] PORT_AU_PRINCE = {
        "Rue Capois", "Rue Lamarre", "Avenue John Brown", "Rue Monseigneur Guilloux",
        "Champs de Mars", "Rue Pavée", "Avenue Martin Luther King",
        "Rue Dr. Aubry", "Avenue Independence", "Rue Magny"
    };

    public static final String[] PETION_VILLE = {
        "Rue Lamarre", "Avenue N", "Rue Charéron", "Rue Boyer",
        "Bourdon", "Turgeau", "Avenue John Brown Ext.",
        "Rue M. R. Laraque", "Delmas 33", "Tabarre 26"
    };
    ...
    public static String randomAddress(String segment) {
        String[] arr = switch (segment == null ? "" : segment) {
