...
/**
 * Service des achats (restructuration 2026-07-24 — module :purchasing).
 *
...
public class PurchasingService {
    ...
    private final WithholdingRulePort withholdingRulePort;  // Audit v4.7 §4.1 Finding #2 — port pour éviter cycle :purchasing ↔ :tax
    ...
    // Finding #14 — barème progressif : Jackson pour parser bracketsJson.
     ...
     *
     * <p><b>Audit v4.7 §4.1 Finding #2 — FIX CRITIQUE</b> : la v4.7 n'appliquait JAMAIS les
    ...
    private void generatePurchaseEntry(UUID companyId, PurchaseInvoice invoice) {
        ...
        // ── Audit v4.7 §4.1 Finding #2 — calcul de la retenue à la source fournisseur ──
     ...
     *
     * <p><b>Audit v4.7 §4.1 Finding #2</b> : charge les {@link WithholdingRule} actives pour
     ...
     *
     * <p><b>Finding #14 — barème progressif (PAS FR)</b> : si une règle a
    ...
    private BigDecimal calculateSupplierWithholding(UUID companyId, BigDecimal subtotalHt) {
        ...
        // Audit v4.7 §4.1 Finding #2 — utiliser le port WithholdingRulePort (défini dans :core,
        ...
        for (WithholdingRuleSnapshot rule : supplierRules) {
            ...
            if (bracketType == WithholdingBracketType.PROGRESSIVE) {
                // Finding #14 — calcul par tranches successives.
    ...
    /**
     * Calcule la retenue progressive par tranches — Finding #14.
     *
    ...
    /** DTO interne pour le parsing Jackson du bracketsJson — Finding #14. */
    ...
    private Account resolveChargeAccount(UUID companyId, UUID expenseAccountId) {
        if (expenseAccountId != null) {
            ...
            // Audit v4.7 §6.2 Finding #3 — IDOR critique (clone du pattern ExpensesService corrigé) :
    ...
    /**
     * Liste paginée des factures d'achat — Finding #3.
     *
