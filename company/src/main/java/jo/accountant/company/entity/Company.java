...
public class Company {
    ...
    /**
     * Référentiel comptable — positionné à l'étape 6 du wizard (restructuration 2026-07-24).
    ...
    /**
     * V66 (R-F-validation lot-G) — TRUE si la société est agréée zone franche
     * (CODEVI / SONAPI — Code Fiscal Haïti art. 195). IS réduit 15% au lieu de 30%.
     *
     * <p>Colonne créée en migration V66 ; champ JPA exposé en v8-1 pour permettre à
     ...
     *
     * <p>Colonne créée en migration V80. Valeur par défaut {@code STANDARD}.
     */
    @Enumerated(EnumType.STRING)
     ...
     * Colonne créée en migration V83 (module :demo-data).
     */
    ...
    /**
     * Lot B R-20 — Durée légale mensuelle de travail en heures.
     * <ul>
     ...
     * ({@code hourlyRate = baseSalary / monthlyLegalHours}). Avant la R-20, cette valeur était
    ...
    /** V66 — TRUE si société agréée zone franche (Code Fiscal art. 195). */
