...
/**
 * Abstraction du canal de notification sortant (§3.12). Définie dans :core pour que la Phase 1
 * puisse déjà envoyer les emails « invitation utilisateur » et « réinitialisation de mot de
 * passe » SANS dépendre du module complet :notifications (construit en Phase 15).
 *
 ...
 *
 * <p>Quand :notifications sera construit (Phase 15), il deviendra l'implémentation de référence
