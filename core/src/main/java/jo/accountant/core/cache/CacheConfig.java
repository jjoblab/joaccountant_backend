...
/**
 * Configuration du cache applicatif — Caffeine (audit v4.7 §7.2 Finding #3).
 *
 ...
 * comme L2 cache distribué (TODO v4.8) — mais pour 1-3 instances, le cache local suffit car
