...
public class MfaService {
     ...
     * R-02 (lot-A-securite) — fail-fast pour empêcher un démarrage prod avec une clé publique.
     */
    ...
    /**
     * R-02 (lot-A-securite) — Validation au démarrage de la clé de chiffrement MFA.
     *
     ...
     *
     * <p>Règles (inspirées du pattern {@code JwtService.validateSecret()} R-02 §6.1) :
     * <ul>
