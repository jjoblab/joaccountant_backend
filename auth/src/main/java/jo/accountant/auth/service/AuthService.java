...
public class AuthService {
    ...
    public LoginResult login(String email, String password) {
        ...
        // Audit v4.7 §6.2 Finding #5 — audit sécurité LOGIN_FAILED pour email inconnu.
        ...
        // Audit v4.7 §6.2 Finding #5 — audit sécurité LOGIN_SUCCESS.
        events.publishEvent(SecurityAuditEvent.of(
    ...
    public LoginResult refresh(String rawRefreshToken) {
        ...
        if (token.getRevokedAt() != null) {
            ...
            // Audit v4.7 §6.2 Finding #5 — REFRESH_TOKEN_REUSED = signal critique de vol de token.
            events.publishEvent(SecurityAuditEvent.of(
        ...
        // Audit v4.7 §6.2 Finding #5 — REFRESH_TOKEN_ROTATED = usage normal du refresh.
        events.publishEvent(SecurityAuditEvent.of(
    ...
    public void logout(String rawRefreshToken) {
        ...
        refreshTokenRepository.findByTokenHash(hash).ifPresent(token -> {
            if (token.getRevokedAt() == null) {
                token.setRevokedAt(Instant.now());
                refreshTokenRepository.save(token);
                // Audit v4.7 §6.2 Finding #5 — LOGOUT.
                events.publishEvent(SecurityAuditEvent.of(
    ...
    public void initiatePasswordReset(String email) {
        ...
        userRepository.findByEmailIgnoreCase(safeEmail)
            .ifPresent(user -> {
                ...
                // Audit v4.7 §6.2 Finding #5 — PASSWORD_RESET_REQUESTED.
                events.publishEvent(SecurityAuditEvent.of(
    ...
    public void consumePasswordReset(String rawToken, String newPassword) {
        ...
        // Audit v4.7 §6.2 Finding #5 — PASSWORD_RESET_CONSUMED. Événement critique de sécurité :
