...
public class MfaController {
    ...
    public ResponseEntity<MfaSetupResponse> setup(@CurrentUser UUID userId) {
        // R-10 (audit qualité/arch) — On récupère le VRAI email de l'utilisateur depuis la DB
     ...
     * Audit mobile #28 / Finding #13 — MFA OWNER/ADMIN obligatoire.
     *
     ...
     *       n'est pas activée — TODO v4.9, nécessite un intercepteur AOP.</li>
     * </ul>
     */
