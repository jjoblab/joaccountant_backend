-- V19_003 — vat mode encaissement
-- V44 — — TVA sur encaissement (régime des encaissements, art. 289 II CGI).
-- , le module :tax ne supportait que le régime des débits (TVA exigible à l'émission
