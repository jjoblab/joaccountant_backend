-- V19_005 — tax rule type and tca seeds
-- V55 — Lot B — Ajout colonne tax_type sur tax_rule + seeds TCA/TVA Haïti.
-- , toutes les TaxRule étaient implicitement considérées comme de la TVA. Or, le
