-- V19_004 — withholding rule progressive brackets
-- V46 — — WithholdingRule barème progressif (PAS FR).
-- , le module :tax ne supportait que le taux unique (FLAT) sur les retenues à la
