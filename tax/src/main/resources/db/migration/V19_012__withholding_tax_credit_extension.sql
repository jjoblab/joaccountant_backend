-- V19_012 — withholding tax credit extension
...
-- : la table tax_credit_carried_forward (créée antérieurement — avant
...
-- période à l'autre (cf. commentaire "" dans TaxService.getWithholdingDeclaration).
