 ...
 *   <li><b>DES</b> (Déclaration d'Échanges de Services intra-UE B2B, art. 289 B CGI) — TODO v4.9,
 *       nécessite l'agrégation par pays UE du tiers.</li>
 *   <li><b>EFI</b> (Échange de Formulaires Informatisé) — TODO v4.9, génère le XML EDI pour
...
public class TaxExportService {
     ...
     * {@code InvoiceLineTax} (type=TCA) — la multi-taxe par ligne est supportée depuis V67.
    ...
    public byte[] exportDgiTca(UUID companyId, int year, int month) {
        ...
        // supportée (V67 + InvoiceLineTax + TaxService.getDeclaration(taxType)).
