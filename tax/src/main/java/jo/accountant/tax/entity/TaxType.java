 ...
 *
 * <p>Avant la , toutes les {@link TaxRule} étaient implicitement considérées comme de la TVA.
 ...
 * <li><b>WITHHOLDING</b> — Retenue à la source (RS) sur factures clients (art. 156-1
 * Code Fiscal Haïti). Reversée à la DGI pour le compte des clients. Peut générer
 * un crédit reportable si les avoirs dépassent les factures sur une période.</li>
 * </ul>
 *
...
public enum TaxType {
 ...
 EXCISE,
 /**
 * Retenue à la source (RS) sur factures clients — art. 156-1 Code Fiscal Haïti.
 * Impôt à reverser à la DGI pour le compte des clients. Le solde peut devenir
 * négatif (crédit reportable) si les avoirs dépassent les factures sur la période.
 */
 WITHHOLDING
}
