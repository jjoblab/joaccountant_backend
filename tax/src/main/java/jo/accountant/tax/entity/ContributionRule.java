...
/**
 * Règle de cotisation sociale pour le moteur de paie (audit v4.7 §4.1 Finding #3).
 *
...
public class ContributionRule {
    ...
    /**
     * Lot B R-25 — type de barème pour les cotisations à barème progressif (ex: AST Haïti).
    ...
    /**
     * Lot B R-25 — barème progressif par tranches au format JSON
