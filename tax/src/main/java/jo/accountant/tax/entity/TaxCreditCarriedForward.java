...
/**
 * Crédit de TVA reporté d'une période à la suivante (Lot B R-23).
 *
 * <p>Avant la R-23, le crédit de TVA (quand TVA déductible &gt; TVA collectée) était calculé
 ...
 * colonne company_id (la PK est un UUID standard). La RLS PostgreSQL (V51) protège
