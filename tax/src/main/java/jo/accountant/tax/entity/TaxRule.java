 ...
 *
 * <p><b>Finding #6 — TVA sur encaissement</b> : le champ {@link #vatMode} indique si la TVA est
...
public class TaxRule {
    ...
    /**
     * Mode d'exigibilité de la TVA (Finding #6). {@link VatMode#DEBIT} par défaut (régime des
    ...
    /**
     * Type de taxe (Lot B — R-07 fiscalité Haïti). {@link TaxType#VAT} par défaut pour
