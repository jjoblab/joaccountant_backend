...
/**
 * Règle d'Impôt sur les Sociétés (IS) — audit v4.7 §4.1 Finding #4.
 *
...
public class CorporateTaxRule extends TenantAwareEntity {
     ...
     * Colonne déjà créée en V65 — exposée côté Java uniquement en v8-1.
     */
     ...
     * de résoudre directement la règle ZF pour un pays donné. Colonne déjà créée en V65 —
     ...
     * de résoudre directement la règle ONG pour un pays donné. Colonne créée en V79.
     */
