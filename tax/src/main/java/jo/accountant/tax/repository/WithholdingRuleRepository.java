...
public interface WithholdingRuleRepository extends JpaRepository<WithholdingRule, UUID> {
     ...
     * Utilisé par :payroll (restructuration 2026-07-24) pour calculer les retenues salariales
     ...
     * pour le lookup par code des règles globales par pays (ex : seeds Haïti V64 —
