-- V60 — R-42 (lot-F1-code-arch) — PCN_HAITI : comptes spécifiques + contrainte chk_account_reporting_class étendue.
--
-- Problème : avant R-42, le PCN Haïtien était traité comme un SYSCOHADA renommé. La classe 8
...
-- ════════════════════════════════════════════════════════════════════════
-- La contrainte chk_account_reporting_class a été créée en V5_001 avec seulement 5 valeurs
-- (ACTIF, PASSIF, CAPITAUX_PROPRES, PRODUITS, CHARGES). R-42 ajoute OTHER pour les Comptes
