-- V5_002 — vat accounts 447 4438 seeds
-- V50 — — Seed comptes 447 + 4438 dans les plans SYSCOHADA et PCG_FRANCE.
-- , les comptes 447 (TVA autoliquidation / reverse-charge) et 4438 (TVA différée non
...
-- encaissement (, VatMode.ENCAISSEMENT) levait l'erreur
