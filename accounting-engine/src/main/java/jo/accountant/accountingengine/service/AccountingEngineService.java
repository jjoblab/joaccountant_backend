...
public class AccountingEngineService {
    ...
    // Finding #2 (refactor batch 2) — la logique de clôture d'exercice est déléguée à un service
    ...
    // Finding #17 (refactor batch C) — la logique de cycle de vie des écritures (postage,
     ...
     *
     * <p>§2 Option A (stabilization 2026-07-25) : l'exercice "actif" n'est plus un état partagé
    ...
    public JournalEntryResponse createJournalEntry(UUID companyId, String idempotencyKey,
        ...
        // §1 fix (stabilization 2026-07-25): removed the pre-check based on the shared
     ...
     *
     * <p><b>Finding #17 (refactor batch C) — extraction du God class</b> : le corps de cette
    ...
    // Finding #17 (refactor batch C) — onApprovalDecided listener et validateAnalyticalTags ont
     ...
     *
     * <p><b>Finding #17 (refactor batch C)</b> : délègue à
     ...
     *
     * <p><b>Audit v4.7 §3.1 Finding #2 — FIX</b> : la version originale utilisait
     ...
     *
     * <p><b>Finding #2 (refactor batch 2) — extraction du God class</b> : le corps de cette
     ...
     *   <li>Génère l'écriture d'ouverture N+1 (à-nouveau — audit v4.7 §3.1 Finding #8).</li>
    ...
    /**
     * Keyset pagination des écritures (R-41 — lot-F1-code-arch).
     *
    ...
    public List<TrialBalanceLine> getTrialBalance(UUID companyId, LocalDate from, LocalDate to) {
        // R-11 (lot-C-perf-devops) — agrégation SQL au lieu de charger toutes les lignes en Java.
