...
public interface JournalLineRepository extends JpaRepository<JournalLine, UUID> {
     ...
     *
     * <p><b>Audit v4.7 §7.2 Finding #1 — FIX N+1 CRITIQUE</b> : la v4.7 chargeait
     ...
     * {@code (company_id, third_party_id)} (à ajouter en migration V36 ou via index dédié).
    ...
    // =========================================================================
    // R-11 (lot-C-perf-devops) — Agrégations SQL pour états financiers / balance
    // =========================================================================
    //
    ...
    /**
     * R-11 — Agrège les lignes POSTED d'une entreprise par compte, jusqu'à une date donnée.
     *
    ...
    /**
     * R-11 — Agrège les lignes POSTED d'une entreprise par compte, sur une plage de dates.
     *
    ...
    /**
     * V73 — v7-2 : Somme des soldes des comptes CAPITAUX_PROPRES à une date donnée.
     *
    ...
    /**
     * V73 — v7-2 : Somme des mouvements (debit - credit) pour les comptes dont le code
    ...
    /**
     * R-11 — Projection pour les agrégations SQL par compte.
     *
