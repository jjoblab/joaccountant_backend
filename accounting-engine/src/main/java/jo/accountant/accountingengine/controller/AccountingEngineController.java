...
public class AccountingEngineController {
 ...
 @Operation(summary = "Keyset pagination des écritures",
 ...
 documentGenerationService, companyId, GeneratedDocumentType.TRIAL_BALANCE_REPORT, variables, filename);
 ...
 ResponseEntity<byte[]> response = PdfEndpointHelper.generatePdf(
 documentGenerationService, companyId, GeneratedDocumentType.LEDGER_REPORT, variables, filename);
