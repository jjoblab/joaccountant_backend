 ...
 *
 * <p><b>R-34 (lot-F1-code-arch) — Rich aggregate methods</b> : cette entité était auparavant
...
public class JournalEntry extends TenantAwareEntity {
    ...
    /**
     * R-34 (lot-F1-code-arch) — Raison de l'annulation (contre-passation). Null si l'écriture
     * n'est pas VOIDED. Colonne ajoutée par la migration V61.
     */
    @Column(name = "void_reason", length = 500)
    private String voidReason;

    /**
     * R-34 (lot-F1-code-arch) — Collection transiente (non persistée) des lignes de l'écriture.
     *
    ...
    /** R-34 — Raison de l'annulation (VOIDED). Null si l'écriture n'est pas VOIDED. */
    public String getVoidReason() { return voidReason; }
    public void setVoidReason(String voidReason) { this.voidReason = voidReason; }

    /**
     * R-34 — Collection transiente des lignes de l'écriture (cf. {@link #lines}).
