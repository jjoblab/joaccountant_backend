...
/**
 * Endpoints de paie (module :payroll).
 *
...
@Tag(name = "Payroll", description = "Paie consolidée, calcul brut→net, bulletin PDF")
public class PayrollController {
 ...
 @Operation(summary = "V86 — v7-4 : Lancer le calcul du 13e mois pour décembre",
 ...
 documentGenerationService, companyId, GeneratedDocumentType.PAYROLL_SUMMARY_REPORT, variables, filename);
 ...
 ResponseEntity<byte[]> response = PdfEndpointHelper.generatePdf(
 documentGenerationService, companyId, GeneratedDocumentType.CNSS_RETURN_REPORT, variables, filename);
