...
/**
 * Catégorie de ligne de note de frais paramétrable (restructuration 2026-07-24 + Finding #19
 * audit batch 1).
 *
 * <p>Historiquement (V25), {@code ExpenseCategory} était un simple enum {@code {TRAVEL, MEALS,
 ...
 *
 * <p><b>Finding #19 — Plafond notes de frais paramétrable</b> : ajout des champs
 ...
 * compatibilité avec le code existant et la contrainte CHECK {@code chk_el_category} posée en V25.
 */
@Entity
...
public class ExpenseCategory extends TenantAwareEntity {
    ...
    /**
     * Plafond journalier par employé/tiers pour cette catégorie (Finding #19).
    ...
    /**
     * Plafond mensuel par employé/tiers pour cette catégorie (Finding #19).
     * Null = pas de plafond (comportement historique).
     */
