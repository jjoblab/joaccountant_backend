...
/**
 * Service des notes de frais (restructuration 2026-07-24 — module :expenses).
 *
...
public class ExpensesService {
    ...
    public ExpenseReportResponse create(UUID companyId, CreateExpenseReportRequest req) {
        ...
        // Finding #19 — valider les plafonds journaliers/mensuels par catégorie
    ...
    public ExpenseReportResponse submit(UUID companyId, UUID reportId) {
        ...
        // Finding #19 — re-valider les plafonds journaliers/mensuels à la soumission (le
    ...
    /**
     * Liste paginée des notes de frais — Finding #3.
     *
    ...
    private Account resolveChargeAccount(UUID companyId, UUID expenseAccountId) {
        if (expenseAccountId != null) {
            ...
            // Audit v4.7 §6.2 Finding #3 — IDOR critique : sans ce guard, un BOOKKEEPER de la
    ...
    /**
     * Valide les plafonds journaliers et mensuels par catégorie (Finding #19 — audit batch 1).
     *
