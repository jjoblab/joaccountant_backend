...
/**
 * Service dédié au CRUD des catégories de notes de frais (Finding #12 — audit batch B).
 *
 * <p>Historiquement, les catégories étaient uniquement créées via le seed V43 (4 codes
 ...
 * par {@code uc_expense_category_company_code} (V43). En cas de doublon, on lève
...
public class ExpenseCategoryService {
     ...
     * @return liste des catégories (codes standards seedés par V43 + codes personnalisés)
     */
