-- V43 — Finding #19 (audit batch 1) — Plafonds paramétrables par catégorie de note de frais.
--
-- Avant V43, ExpenseCategory était un simple enum Java {TRAVEL, MEALS, SUPPLIES, OTHER} et la
