...
public class Asset extends TenantAwareEntity {
    ...
    /**
     * Dépréciation IAS 36 cumulée (Finding #11). 0 tant qu'aucun test de dépréciation
    ...
    /**
     * Compte de CHARGES pour la dépréciation IAS 36 (Finding #11).
    ...
    /**
     * Compte d'ACTIF pour la dépréciation IAS 36 cumulée (Finding #11).
