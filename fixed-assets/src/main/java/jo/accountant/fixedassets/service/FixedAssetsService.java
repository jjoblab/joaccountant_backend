 ...
 */
 ...
 // comptes de dépréciation IAS 36 (optionnels, fallback sur amortissement).
 ...
 // persister les composants IAS 16 fournis à la création (optionnels).
 ...
 */
 ...
 // valider les comptes de dépréciation IAS 36 s'ils sont fournis.
 ...
 // valider les composants IAS 16 fournis (unicité du code par asset,
 ...
 */
 ...
 /**
 * Génère l'échéancier d'amortissement pour un composant IAS 16.
 *
 ...
 */
 ...
 // avec les composants IAS 16, plusieurs lignes peuvent matcher (une par
 ...
 */
 ...
 // ── Amortissement complémentaire avant cession (audit batch 1) ──
 ...
 * postée et la date de cession (audit batch 1).
 *
 ...
 */
 ...
 // Durée de vie en années = usefulLifeMonths / 12 (Formule ).
 ...
 /**
 * Ajoute un composant IAS 16 à une immobilisation existante.
 *
 ...
 */
 ...
 /**
 * Teste la dépréciation IAS 36 d'une immobilisation.
 *
